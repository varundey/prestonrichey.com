...
I hope this was informative and will help you when you need to do something similar. You can find the copy of this post at [dev.to](https://dev.to/varundey/destructuring-javascript-objects-with-default-value-5b7d). ✌️
